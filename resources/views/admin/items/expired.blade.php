            ...
            <tbody>
                @foreach ($expired as $itemId => $transactions)
                    ...
                    <tr class="table-danger">
                        ...
                        <td>
                            <a href="{{ route('admin.inventory') }}" class="btn btn-primary btn-sm">
                                Inventory
                            </a>
                            <a href="{{ route('admin.stock.adjustment') }}" class="btn btn-warning btn-sm">
                                Adjust Stock
                            </a>
                            <a href="{{ route('admin.items.transactions', $item->id) }}" class="btn btn-info btn-sm">
                                View History
                            </a>
                        </td>
                    </tr>
