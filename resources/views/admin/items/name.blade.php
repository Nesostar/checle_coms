...
<div class="container">
    ...
    <form action="{{ route('admin.items.names.store') }}" method="POST">
            @csrf
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{-- Delete Button --}}
                        <form action="{{ route('admin.items.names.destroy', $item->id) }}"
                ...
                <div class="modal fade" id="editItemModal{{ $item->id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.items.names.update', $item->id) }}"
                                  method="POST">
                                @csrf
                                @method('PUT')
