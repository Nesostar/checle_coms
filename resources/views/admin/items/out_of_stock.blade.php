            ...
            <tbody>
                @foreach ($items as $item)
                    ...
                    <tr class="{{ $stock <= 0 ? 'table-danger' : '' }}">
                        ...
                        <td>
                            <a href="{{ route('admin.items.inventory.index') }}" class="btn btn-sm btn-primary">
                                View Inventory
                            </a>
                            <a href="{{ route('admin.items.inventory.transactions', $item->id) }}" class="btn btn-sm btn-info">
                                View History
                            </a>
                        </td>
                    </tr>
