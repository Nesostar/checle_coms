...
<div class="container">
    ...
    <td>
                        ...
                        {{-- Delete --}}
                        <form action="{{ route('admin.items.entrytype.destroy', $type->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                ...
                <div class="modal fade" id="editEntryType{{ $type->id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{ route('admin.items.entrytype.update', $type->id) }}" method="POST">
                                @csrf
                                @method('PUT')
