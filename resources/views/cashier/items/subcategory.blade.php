...
<div class="container">
    ...
    <div class="card mt-3 p-3">
        <form action="{{ route('cashier.items.subcategories.store') }}" method="POST">
            @csrf
                ...
                @foreach($subcategories as $subcategory)
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- DELETE -->
                            <form action="{{ route('cashier.items.subcategories.destroy', $subcategory->id) }}"
...
<script>
    function openEditModal(id, name, category_id) {
        ...
        document.getElementById('editForm').action =
            "{{ url('/cashier/items/subcategories/update') }}/" + id;
